        ...
        <div className="glass-card p-6">
          <form onSubmit={handleAnalyze} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-overlay border border-border rounded-xl text-foreground placeholder-gray-500 focus:outline-none focus:border-accent-blue transition-colors"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={10}
                  className="w-full pl-10 pr-4 py-3 bg-overlay border border-border rounded-xl text-foreground placeholder-gray-500 focus:outline-none focus:border-accent-blue transition-colors resize-none"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-accent-blue to-accent-purple text-foreground font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden"
            >
              {loading ? (
                <>
          ...
          <AnimatePresence mode="wait">
            ...
            {loading && (
              ...
              >
                ...
                <p className="text-muted animate-pulse">Running AI Analysis...</p>
              </motion.div>
            )}
            ...
            {result && !loading && (
              ...
              >
                {/* Score Header */}
                <div className="flex items-center justify-between p-6 bg-overlay rounded-2xl border border-border">
                  <div>
                    <h3 className="text-lg font-medium text-muted">Overall Match Score</h3>
                ...
                <div className="space-y-4">
                  <h4 className="text-foreground font-medium border-b border-border pb-2">AI Recommendations</h4>
                  <ul className="space-y-3">
                    {result.recommendations.map((rec, idx) => (
                      <li key={idx} className="flex items-start gap-3 text-sm text-muted bg-overlay p-3 rounded-lg border border-border">
