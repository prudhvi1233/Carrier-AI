  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-sm bg-dropdown border border-border shadow-2xl rounded-2xl overflow-hidden"
      >
        <div className="p-6 text-center flex flex-col items-center">
          ...
          <div className="flex gap-3 w-full">
            ...
            <button
              onClick={onConfirm}
              className="flex-1 px-4 py-2.5 rounded-xl bg-red-500 hover:bg-red-600 text-foreground font-bold transition-colors shadow-lg shadow-red-500/20"
            >
              Logout
            </button>
          </div>
