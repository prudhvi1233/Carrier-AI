...
export default function TopNavbar() {
  ...
  return (
    <>
      <nav className="fixed top-4 left-4 right-4 max-w-7xl mx-auto z-50 h-[76px] bg-secondary backdrop-blur-3xl border border-border rounded-2xl shadow-2xl shadow-black/50 px-6 flex items-center justify-between transition-all duration-500">
        ...
        <div className="flex items-center gap-8">
          <Link to="/dashboard" className="flex items-center gap-3 shrink-0">
            ...
            <span className="font-bold text-xl tracking-tight hidden lg:block text-foreground mr-4">CareerAI</span>
          </Link>

          <div className="hidden lg:flex items-center gap-1.5 p-1 bg-overlay rounded-full border border-border">
        ...
        <div className="lg:hidden flex items-center gap-4">
          <button 
            className="p-2 text-muted hover:text-foreground hover:bg-overlay rounded-xl transition-colors"
        ...
        <div className="hidden lg:flex items-center gap-4">
          <div className="flex items-center gap-2 bg-overlay rounded-full border border-border p-1">
            <NotificationBell />
          </div>
          
          <div className="w-px h-8 bg-overlay-hover" />

          <div className="bg-overlay rounded-full border border-border p-1 flex items-center">
