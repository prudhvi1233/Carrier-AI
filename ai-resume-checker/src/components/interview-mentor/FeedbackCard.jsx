      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400">Score: {feedback.score}/100</p>
          </div>
          <button 
            onClick={onNext}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {metrics.map(m => (
            <div key={m.label} className="bg-white/5 border border-white/5 rounded-xl p-4 flex flex-col items-center justify-center gap-2">
        ...
        <div className="bg-accent-blue/10 border border-accent-blue/20 rounded-xl p-4 space-y-4">
          <div>
            <h5 className="font-bold text-white mb-2">Strengths & Weaknesses</h5>
          ...
          <div>
            <h5 className="font-bold text-white mb-2">Improvement Suggestions</h5>
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed italic border-l-2 border-accent-blue pl-3">{feedback.ideal_answer}</p>
          </div>
        </div>
