  ...
  return (
    <div className="bg-secondary/40 backdrop-blur-xl border border-border rounded-2xl p-6 shadow-xl">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="h-64">
          <h4 className="text-sm text-center text-muted mb-4">Category Score</h4>
        ...
        <div className="h-64">
          <h4 className="text-sm text-center text-muted mb-4">Keyword Categories (Found vs Missing)</h4>
          <ResponsiveContainer width="100%" height="100%">
