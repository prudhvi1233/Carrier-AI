  ...
  return (
    <div className="bg-secondary/40 backdrop-blur-xl border border-border rounded-2xl p-6 shadow-xl">
      ...
      <div className="space-y-6">
        <div>
          <h4 className="text-sm text-muted mb-2">Keywords Found</h4>
          <div className="flex flex-wrap gap-2">
            {keywords.found.map(kw => (
              <span key={kw} className="px-2 py-1 bg-overlay border border-border text-muted rounded text-sm">
                {kw}
              </span>
            ))}
          </div>
        ...
        <div>
          <h4 className="text-sm text-muted mb-2">Missing Keywords</h4>
          <div className="flex flex-wrap gap-2">
        ...
        <div>
          <h4 className="text-sm text-muted mb-2">Suggested Additions</h4>
          <div className="flex flex-wrap gap-2">
