  ...
  return (
    <div className="glass-card p-6 h-full relative overflow-hidden flex flex-col">
      <div className="flex items-center gap-3 mb-4 relative z-10">
        <div className="p-2.5 bg-gradient-to-br from-accent-purple/20 to-accent-blue/20 rounded-xl border border-border text-foreground">
          <Bot size={20} className="text-accent-purple" />
        </div>
        <h3 className="text-lg font-semibold text-foreground">AI Executive Summary</h3>
      </div>
