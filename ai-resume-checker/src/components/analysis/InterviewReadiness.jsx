    ...
    <div className="glass-card p-6 h-full flex flex-col relative overflow-hidden group">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10 gap-6">
        <div className="flex items-end justify-center w-full">
          <span className="text-6xl font-bold tracking-tighter text-white">{readiness}</span>
          <span className="text-lg text-gray-400 font-medium mb-1.5 ml-1">/ 100</span>
        </div>

        <div className="w-full flex flex-col gap-2 items-center">
          <span className="text-sm text-gray-400 uppercase tracking-wider font-semibold">Confidence Meter</span>
