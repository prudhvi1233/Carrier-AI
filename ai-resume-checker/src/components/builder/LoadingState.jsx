  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] w-full">
      <div className="relative w-24 h-24 mb-8">
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-secondary rounded-full border-2 border-border z-10">
          <Icon size={32} className="text-foreground animate-pulse" />
        </div>
      </div>
      
      <h3 className="text-xl font-bold text-foreground mb-2 tracking-wide animate-pulse">
        {currentStep.text}
      </h3>
      <p className="text-muted text-sm">Please wait while we prepare your resume.</p>
    </div>
  );
}
