  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="mb-2">
        ...
        <p className="text-gray-400">Please provide your educational background.</p>
      </div>
      ...
      <div className="flex flex-col gap-8">
        ...
        >
          <h3 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">Degree / Graduation</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2">
              <label className="text-xs font-medium text-gray-400">Degree Name</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-medium text-gray-400">Specialization</label>
              <input 
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              <label className="text-xs font-medium text-gray-400">University / College</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-medium text-gray-400">Start Year</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-medium text-gray-400">End Year (or Expected)</label>
              <input 
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              <div className="flex justify-between">
                 <label className="text-xs font-medium text-gray-400">CGPA</label>
              ...
              <input 
                ...
                placeholder="e.g. 8.5"
                className={`w-full bg-black/20 border rounded-lg px-3 py-2 text-white focus:outline-none ${validateCGPA(edData.degree?.cgpa) ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:border-accent-blue'}`}
              />
            </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="glass-card p-6 border-white/10"
        >
          <h3 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">Intermediate (12th)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2 md:col-span-2">
              <label className="text-xs font-medium text-gray-400">College / Institution</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-medium text-gray-400">Board</label>
              <input 
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs font-medium text-gray-400">Passing Year</label>
              <input 
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              ...
              <input 
                ...
                className={`w-full bg-black/20 border rounded-lg px-3 py-2 text-white focus:outline-none ${validatePercentage(edData.twelfth?.percentage) ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:border-accent-blue'}`}
              />
            </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="glass-card p-6 border-white/10"
        >
          <h3 className="text-xl font-bold text-white mb-4 border-b border-white/10 pb-2">Matriculation (10th)</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-2 md:col-span-2">
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              ...
              <input 
                ...
                className={`w-full bg-black/20 border rounded-lg px-3 py-2 text-white focus:outline-none ${validatePercentage(edData.tenth?.percentage) ? 'border-red-500 focus:border-red-500' : 'border-white/10 focus:border-accent-blue'}`}
              />
            </div>
          </div>
        </motion.div>
