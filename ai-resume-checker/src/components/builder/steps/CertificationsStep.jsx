  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="mb-2">
        ...
        <p className="text-muted">Add relevant certificates, licenses, or courses you have completed.</p>
      </div>
        ...
        <AnimatePresence initial={false}>
          {data.map((c, idx) => (
            <motion.div 
              ...
              className="glass-card p-4 border-border relative group flex items-start gap-4"
            >
              ...
              <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-medium text-muted">Certification Name</label>
                  <input 
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-medium text-muted">Issuing Organization</label>
                  <input 
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-medium text-muted">Date Issued</label>
                  <input 
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-medium text-muted">Credential URL</label>
                  <input 
