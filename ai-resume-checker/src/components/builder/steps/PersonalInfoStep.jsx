  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="mb-2">
        ...
        <p className="text-muted">Let's start with the basics. This is how employers will contact you.</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-muted">First Name <span className="text-red-400">*</span></label>
          <input 
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-muted">Last Name <span className="text-red-400">*</span></label>
          <input 
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium text-muted">Email Address <span className="text-red-400">*</span></label>
          <input 
        ...
        <div className="flex flex-col gap-2 md:col-span-2">
          <label className="text-sm font-medium text-muted">Location (City, Country)</label>
          <input 
        ...
        <div className="flex flex-col gap-2 md:col-span-2">
          <label className="text-sm font-medium text-muted">Portfolio / Website</label>
          <input 
