  ...
  return (
    <div className="flex flex-col gap-6 h-full">
      <div className="mb-2">
        ...
        <p className="text-muted">Write a short, engaging pitch about your career. Keep it under 4-5 sentences.</p>
      </div>
      ...
      <div className="glass-card p-6 border-accent-purple/30 bg-accent-purple/5 flex flex-col md:flex-row gap-6 items-center justify-between">
        <div>
          <h3 className="text-foreground font-bold mb-1">Stuck on what to write?</h3>
          <p className="text-sm text-muted">Our AI can analyze your provided job titles and automatically generate a compelling, ATS-optimized summary tailored for you.</p>
        </div>
        <button 
          onClick={handleAI}
      ...
      <div className="flex flex-col gap-2 flex-1 min-h-[300px]">
        ...
        <textarea 
          ...
          className="w-full h-full min-h-[200px] bg-overlay border border-border rounded-xl px-4 py-4 text-foreground focus:outline-none focus:border-accent-blue focus:ring-1 focus:ring-accent-blue transition-colors resize-none leading-relaxed"
        />
      </div>
    </div>
  );
