      ...
      <div className="glass-card p-6 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 max-w-xl">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-black/20 border border-white/10 rounded-xl pl-4 pr-12 py-3 text-white focus:outline-none focus:border-accent-blue focus:ring-1 focus:ring-accent-blue transition-colors"
                required
              />
              <button 
                type="button" 
            ...
            {passwords.new && (
              <div className="flex flex-col gap-1 mt-2">
                <div className="flex gap-1 h-1.5 w-full">
                  <div className={`flex-1 rounded-full ${strength >= 25 ? strengthColor : 'bg-white/10'}`} />
                  <div className={`flex-1 rounded-full ${strength >= 50 ? strengthColor : 'bg-white/10'}`} />
                  <div className={`flex-1 rounded-full ${strength >= 75 ? strengthColor : 'bg-white/10'}`} />
                  <div className={`flex-1 rounded-full ${strength >= 100 ? strengthColor : 'bg-white/10'}`} />
                </div>
          ...
          <div className="pt-2">
            <button 
              type="submit"
              className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white/10 hover:bg-white/15 text-white font-medium border border-white/10 transition-colors"
            >
              <Save size={18} />
              Update Password
            </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6 flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6">Add an extra layer of security to your account by requiring a code from your mobile device.</p>
          </div>
          <label className="flex items-center justify-between cursor-pointer group">
            <span className="font-medium text-white group-hover:text-gray-200 transition-colors">Enable 2FA</span>
            <div className="relative">
        ...
        <div className="glass-card p-6 flex flex-col justify-between border-red-500/20">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-6">If you notice suspicious activity, you can securely log out of all other devices.</p>
          </div>
          <button 
