  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-2">
        ...
        <p className="text-gray-400 text-sm">Control who sees your profile and how your data is used.</p>
      </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center justify-between gap-4 py-4 border-b border-white/5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-white font-medium mb-1">Make Profile Private</span>
                <span className="text-sm text-gray-400">If enabled, your profile will not be visible to recruiters or public searches.</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between gap-4 py-4 border-b border-white/5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-white font-medium mb-1">Allow Anonymous Analytics</span>
                <span className="text-sm text-gray-400">Help us improve our AI models by allowing us to use your anonymized resume data.</span>
              </div>
            </div>
            <label className="relative cursor-pointer shrink-0">
          ...
          <div className="flex items-center justify-between gap-4 py-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-white font-medium mb-1">Auto-delete Resumes</span>
                <span className="text-sm text-gray-400">Automatically delete your uploaded resumes and their analyses after a certain period.</span>
              </div>
            </div>
            <select
              value={settings.autoDelete}
              onChange={(e) => updateSelect('autoDelete', e.target.value)}
              className="bg-black/20 border border-white/10 rounded-xl px-4 py-2 text-white text-sm focus:outline-none focus:border-accent-blue cursor-pointer min-w-[120px]"
            >
