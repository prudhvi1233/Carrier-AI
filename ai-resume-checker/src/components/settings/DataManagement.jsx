  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="mb-2">
        ...
        <p className="text-muted text-sm">Download your data or permanently delete information from our servers.</p>
      </div>

      <div className="glass-card p-6 md:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
          <h3 className="text-lg font-bold text-foreground mb-1">Export Data Archive</h3>
          <p className="text-muted text-sm">Download a ZIP file containing all your uploaded resumes, analyses in JSON format, and profile data.</p>
        </div>
        <button 
      ...
      <div className="glass-card p-6 md:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div>
          <h3 className="text-lg font-bold text-foreground mb-1">Clear Resume History</h3>
          <p className="text-muted text-sm">Permanently delete all previously analyzed resumes and their reports. Your account remains active.</p>
        </div>
        <button 
          onClick={handleDeleteHistory}
          className="flex items-center gap-2 px-6 py-3 rounded-xl bg-overlay hover:bg-overlay-hover text-foreground font-medium border border-border transition-colors shrink-0 w-full sm:w-auto justify-center"
        >
          <Trash2 size={18} />
          Clear History
        </button>
      ...
      <div className="glass-card p-6 md:p-8 border-red-500/20 bg-red-500/5 mt-4">
        ...
        <button 
          ...
          className="flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-red-500 hover:bg-red-600 text-foreground font-medium shadow-lg hover:shadow-red-500/25 transition-all w-full sm:w-auto"
        >
          <Trash2 size={18} />
